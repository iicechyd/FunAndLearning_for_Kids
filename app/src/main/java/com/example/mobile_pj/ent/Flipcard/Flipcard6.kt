...
class Flipcard6 : AppCompatActivity() {
    var next : Button? = null
    var back : Button? = null
    private lateinit var cardImg: ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_flipcard6)
        init()
        next!!.setOnClickListener {
            var intent = Intent(this, Flipcard7::class.java)
        ...
        oa1.addListener(object : AnimatorListenerAdapter(){
            override fun onAnimationEnd(animation: Animator) {
                ...
                if (cardImg.drawable.constantState == resources.
                    getDrawable(R.drawable.flip_b6).constantState){
                    cardImg.setImageResource(R.drawable.flip_f6)
                }else{
                    cardImg.setImageResource(R.drawable.flip_b6)
                }
                oa2.start()
            }
        })
