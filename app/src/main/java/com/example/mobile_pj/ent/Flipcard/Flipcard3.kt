...
class Flipcard3 : AppCompatActivity() {
    var next : Button? = null
    var back : Button? = null
    private lateinit var cardImg: ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_flipcard3)
        init()
        next!!.setOnClickListener {
            var intent = Intent(this, Flipcard4::class.java)
        ...
        oa1.addListener(object : AnimatorListenerAdapter(){
            override fun onAnimationEnd(animation: Animator) {
                ...
                if (cardImg.drawable.constantState == resources.
                    getDrawable(R.drawable.flip_b3).constantState){
                    cardImg.setImageResource(R.drawable.flip_f3)
                }else{
                    cardImg.setImageResource(R.drawable.flip_b3)
                }
                oa2.start()
            }
        })
