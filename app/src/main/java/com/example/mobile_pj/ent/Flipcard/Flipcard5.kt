...
class Flipcard5 : AppCompatActivity() {
    var next : Button? = null
    var back : Button? = null
    private lateinit var cardImg: ImageView
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_flipcard5)
        init()
        next!!.setOnClickListener {
            var intent = Intent(this, Flipcard6::class.java)
        ...
        oa1.addListener(object : AnimatorListenerAdapter(){
            override fun onAnimationEnd(animation: Animator) {
                ...
                if (cardImg.drawable.constantState == resources.
                    getDrawable(R.drawable.flip_b5).constantState){
                    cardImg.setImageResource(R.drawable.flip_f5)
                }else{
                    cardImg.setImageResource(R.drawable.flip_b5)
                }
                oa2.start()
            }
        })
